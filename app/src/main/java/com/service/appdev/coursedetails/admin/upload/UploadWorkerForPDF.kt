...
class UploadWorkerForPDF(context: Context, workerParams: WorkerParameters) : Worker(context, workerParams) {
    ...
    override fun doWork(): Result {
        ...
        val announcementId = inputData.getString("announcementId")
        ...
        return try{
            ...
            val response = uploadFile(filePath, announcementId!!)
    ...
    private fun uploadFile(filePaths: Array<String>, announcementId : String): okhttp3.Response {
        ...
        for (filePath in filePaths) {
            ...
            requestBodyBuilder.addFormDataPart("announcementId", announcementId)
